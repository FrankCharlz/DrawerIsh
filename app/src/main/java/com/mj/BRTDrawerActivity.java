...
import com.mikepenz.materialdrawer.mj.R;
...
public class BRTDrawerActivity extends AppCompatActivity {
                ...
                .withOnDrawerItemClickListener(new Drawer.OnDrawerItemClickListener() {
                    ...
                    public boolean onItemClick(AdapterView<?> parent, View view, int position, long id, IDrawerItem drawerItem) {
                        if (drawerItem != null && drawerItem.getIdentifier() == 1) {
                            ...
                            findViewById(R.id.action_mode_bar).setBackgroundColor(UIUtils.getThemeColorFromAttrOrRes(BRTDrawerActivity.this, R.attr.colorPrimary, R.color.material_drawer_primary));
                        }
    ...
    class ActionBarCallBack implements ActionMode.Callback {
        ...
        public boolean onCreateActionMode(ActionMode mode, Menu menu) {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                getWindow().setStatusBarColor(UIUtils.getThemeColorFromAttrOrRes(BRTDrawerActivity.this, R.attr.colorPrimaryDark, R.color.material_drawer_primary_dark));
            }
